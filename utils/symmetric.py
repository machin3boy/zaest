...
def test_one_block():
    ...
    print()
    obj = AES(key)
    e = obj.encrypt_block(message)
    print("encrypted message in bytes:", e)
    print("encrypted message as ints:", [v for v in e]) 
    print("encrypted message as hex:", e.hex())
    d = obj.decrypt_block(e)
    print()
    print("decrypted message:", d.decode('utf-8'))
